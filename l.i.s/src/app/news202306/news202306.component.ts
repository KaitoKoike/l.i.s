...
@Component({
  selector: 'app-news202306',
  templateUrl: './news202306.component.html',
  styleUrls: ['./news202306.component.css']
})
export class News202306Component implements OnInit {
  ...
  news_id = 'news20230630';
  news_sup_title = '2023年6月のメディア掲載情報'
  news_cond_m = "06";
  news_cond_y = '2023'
  news_keys:any[] = [];
  news_list:any[] = [];
  news_conf = NewsTextsProvider.value.news202306;
  news_inf = NewsTextsProvider.info['2023-06-30'];
  news_content:any  ;
