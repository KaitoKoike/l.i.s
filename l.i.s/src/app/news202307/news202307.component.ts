...
@Component({
  selector: 'app-news202307',
  templateUrl: './news202307.component.html',
  styleUrls: ['./news202307.component.css']
})
export class News202307Component implements OnInit {
  ...
  news_id = 'news20230731';
  news_sup_title = '2023年7月のメディア掲載情報'
  news_cond_m = "07";
  news_cond_y = '2023'
  news_keys:any[] = [];
  news_list:any[] = [];
  news_conf = NewsTextsProvider.value.news202307;
  news_inf = NewsTextsProvider.info['2023-07-31'];
  news_content:any  ;
